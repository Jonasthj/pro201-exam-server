...
Historiske kart fra 1800-taller viser at det har ligget flere kvernhus/møller i området og de er også nevnt i skriftlige kilder. Det er tatt vare på flere kvernsteiner/møllesteiner som ligger i private hager i nærområdet.',
       ...
       (3, 'Sagtuft', 22183,
        'Vannsagresten består av 4 oppmurte bærepillarer, plassert parvis på hver sin side av åa. Bygget i hovedsak av stor bruddstein som er noe utrast. Delvis dekket av mose. Mellom pillarene er det rester av tømmerkonstruksjon. Hver av de fire pillarene måler: L ca 5m, h 2-5m, tykkelse ca 1,25m. 2008: Mål: omlag 20 x 10 meter. Orientert øst/vest. Det mest øyensynlige er fire gjenstående, mosegrodde pillarer av stein. Den nordøstre pillaren er særlig godt bevart, og har fortsatt sin opprinnelige form. Strukturene har en rektangulær grunnflate som smalner av mot toppen. De er reist av tørrmurt tilhugget stein, formet i kvadratiske og rektangulære blokker. Lengden på pillarens grunnflate er fem meter, bredden eller tykkelsen er 1,25 meter. Høyden er mellom tre og fem meter. K22183 ligger i åpen skog med store grantrær og ny og eldre løvskog med bjørk og alm, i nordøstvendt hellende terreng mot bekkens utløp i Øyern. Flere store, morkne trestokker ligger omkring pillarene, og er trolig rester etter tømmerkonstruksjon. En kulp i vest der bekken har det største fallet. En eldre kjerrevei/sti går inn til området fra den høyereliggende moderne dyrkningsflaten i vest/nordvest. Det er fra folketellinger fra 1801 opplysninger som knytter gården Bye i Rælingen til sagbruk (Digitalarkivet), men saga kan være eldre enn dette.
...
Ny beskrivelse av sagmurene 2019: Sagruinen består av parallelle murer med 3,50 meters mellomrom. Lengden på murene er 14-15 meter lange. Den vestre muren ligger delvis på berg og her det er en åpning som er 3,80 meter langt tilnærmet midt på muren. Høyden på muren i sør er 2-2,10 meter, i nord er den vestre muren 4,5 meter høy. Tykkelsen på den vestre muren er omtrent 1,45 meter og den østre muren er omtrent 1,60 meter bred.',
        'sagruin_uri', 5, 5),
